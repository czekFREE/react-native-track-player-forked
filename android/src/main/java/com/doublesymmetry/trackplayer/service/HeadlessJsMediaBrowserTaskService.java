 ...
 *
 * <p>If you're starting a {@code HeadlessJsMediaBrowserTaskService} from a {@code BroadcastReceiver} (e.g.
 ...
 * service is started.
 */
public abstract class HeadlessJsMediaBrowserTaskService extends MediaBrowserServiceCompat implements HeadlessJsTaskEventListener {
  ...
  public void onCreate() {
    Log.d("MusicService", "HeadlessJsMediaBrowserTaskService.onCreate()");
    super.onCreate();
  }

  @Override
  public int onStartCommand(Intent intent, int flags, int startId) {
    Log.d("MusicService", "HeadlessJsMediaBrowserTaskService.onStartCommand() " + intent + " , " + flags + " , " + startId);
    ...
    if (sWakeLock == null || !sWakeLock.isHeld()) {
      ...
      sWakeLock =
        powerManager.newWakeLock(
          PowerManager.PARTIAL_WAKE_LOCK, HeadlessJsMediaBrowserTaskService.class.getCanonicalName());
...
//  }
   ...
   *
   * <p>Has to be called on the UI
   thread.
   *
   * @param taskConfig describes what task to start and the parameters to pass to it
   */
  protected void startTask(final HeadlessJsTaskConfig taskConfig) {
    Log.d("MusicService", "HeadlessJsMediaBrowserTaskService.startTask()");
  ...
  public void onDestroy() {
    super.onDestroy();
    Log.d("MusicService", "HeadlessJsMediaBrowserTaskService.onDestroy()");
