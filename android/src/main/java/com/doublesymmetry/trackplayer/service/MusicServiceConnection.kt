...
import com.doublesymmetry.trackplayer.service.MusicServiceConnection.MediaBrowserConnectionCallback
...
class MusicServiceConnection(context: Context, serviceComponent: ComponentName) {
    ...
    private val mediaBrowser = MediaBrowserCompat(
        ...
        Log.d("MusicService", "MusicServiceConnection.mediaBrowser.connect() " + serviceComponent)
    ...
    init {
        Log.d("MusicService", "MusicServiceConnection.init() " + serviceComponent)
    }

    fun subscribe(parentId: String, callback: MediaBrowserCompat.SubscriptionCallback) {
        Log.d("MusicService", "MusicServiceConnection.subscribe()")
        mediaBrowser.subscribe(parentId, callback)
    }

    fun unsubscribe(parentId: String, callback: MediaBrowserCompat.SubscriptionCallback) {
        Log.d("MusicService", "MusicServiceConnection.unsubscribe()")
    ...
    fun sendCommand(
        ...
        Log.d("MusicService", "MusicServiceConnection.sendCommand()")
    ...
    private inner class MediaBrowserConnectionCallback(private val context: Context) :
        ...
        override fun onConnected() {
            Log.d("MusicService", "MediaBrowserConnectionCallback.onConnected()")
            // Get a MediaController for the MediaSession.
            mediaController = MediaControllerCompat(context, mediaBrowser.sessionToken).apply {
                registerCallback(mediaControllerCallback)
            }

//            subscribe("/", object : MediaBrowserCompat.SubscriptionCallback() {
//                override fun onChildrenLoaded(parentId: String, children: List<MediaBrowserCompat.MediaItem>) {
//                    super.onChildrenLoaded(parentId, children)
//                    Log.d("uamp", "onConnected.subscriptionCallback.onChildrenLoaded()")
//                }
//            })
        ...
        override fun onConnectionSuspended() {
            Log.d("MusicService", "MediaBrowserConnectionCallback.onConnectionSuspended()")
        ...
        override fun onConnectionFailed() {
            Log.d("MusicService", "MediaBrowserConnectionCallback.onConnectionFailed()")
            isConnected.postValue(false)
        }
    }
    ...
    companion object {
        ...
        @JvmStatic fun getInstance(context: Context, serviceComponent: ComponentName) =
            instance ?: synchronized(this) {
                Log.d("MusicService", "MusicServiceConnection.getInstance() " + serviceComponent + ", " + context)
